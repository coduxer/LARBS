...
rm tz.tmp
curl https://raw.githubusercontent.com/coduxer/LARBS/master/testing/chroot.sh > /mnt/chroot.sh && arch-chroot /mnt bash chroot.sh && rm /mnt/chroot.sh
...
larbs() { curl -O https://raw.githubusercontent.com/LukeSmithxyz/coduxer/master/src/larbs.sh && bash larbs.sh ;}
